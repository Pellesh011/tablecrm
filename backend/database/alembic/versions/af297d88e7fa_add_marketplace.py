...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_marketplace_rating_aggregates_id"),
        "marketplace_rating_aggregates",
        ["id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_marketplace_utm_tags_id"), "marketplace_utm_tags", ["id"], unique=False
    )
    op.create_table(
        "marketplace_reviews",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_marketplace_reviews_id"), "marketplace_reviews", ["id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_marketplace_view_events_id"),
        "marketplace_view_events",
        ["id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_favorites_nomenclatures_id"),
        "favorites_nomenclatures",
        ["id"],
        unique=False,
    )
    ...
    op.add_column(
        "docs_sales",
        sa.Column(
            "is_marketplace_order", sa.Boolean(), server_default="false", nullable=True
        ),
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_favorites_nomenclatures_id"), table_name="favorites_nomenclatures"
    )
    op.drop_table("favorites_nomenclatures")

    op.drop_index(
        op.f("ix_marketplace_view_events_id"), table_name="marketplace_view_events"
    )
    ...
    op.drop_index(
        op.f("ix_marketplace_rating_aggregates_id"),
        table_name="marketplace_rating_aggregates",
    )
