...
def upgrade() -> None:
    ...
    op.drop_index(
        "ix_segment_version_objects_change_type", table_name="segment_version_objects"
    )
    op.drop_index("ix_segment_version_objects_id", table_name="segment_version_objects")
    op.drop_index(
        "ix_segment_version_objects_object_id", table_name="segment_version_objects"
    )
    op.drop_index(
        "ix_segment_version_objects_object_type", table_name="segment_version_objects"
    )
    ...
    segment_object_type_enum = sa.Enum(
        "docs_sales", "contragents", name="segment_object_type"
    )
    ...
    op.create_index(
        op.f("ix_segment_objects_id"), "segment_objects", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_segment_objects_object_id"),
        "segment_objects",
        ["object_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_segment_objects_object_type"),
        "segment_objects",
        ["object_type"],
        unique=False,
    )
    op.create_index(
        ...
        "segment_objects",
        ["segment_id", "valid_from"],
        unique=False,
    )
    op.create_index(
        "ix_svo_segment_valid_to",
        "segment_objects",
        ["segment_id", "valid_to"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "segments",
        sa.Column("current_version", sa.INTEGER(), autoincrement=False, nullable=True),
    )
    op.create_index(
        "ix_segments_current_version", "segments", ["current_version"], unique=False
    )
    ...
    op.drop_index(op.f("ix_segment_objects_object_type"), table_name="segment_objects")
    op.drop_index(op.f("ix_segment_objects_object_id"), table_name="segment_objects")
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["segment_id"], ["segments.id"], name="segment_versions_segment_id_fkey"
        ),
        sa.PrimaryKeyConstraint("id", name="segment_versions_pkey"),
        sa.UniqueConstraint("segment_id", "version", name="uq_segment_version"),
    )
    op.create_index("ix_segment_versions_id", "segment_versions", ["id"], unique=False)
    op.create_table(
        ...
        sa.Column(
            "object_type",
            postgresql.ENUM("docs_sales", "contragents", name="segment_object_type"),
            autoincrement=False,
            nullable=False,
        ),
        sa.Column(
            "change_type",
            postgresql.ENUM("added", "removed", "existing", name="segment_change_type"),
            autoincrement=False,
            nullable=False,
        ),
        sa.ForeignKeyConstraint(
            ["segment_id"],
            ["segments.id"],
            name="segment_version_objects_segment_id_fkey",
        ),
        sa.ForeignKeyConstraint(
            ["version"],
            ["segment_versions.id"],
            name="segment_version_objects_version_fkey",
        ),
        ...
        sa.UniqueConstraint(
            ...
            "object_type",
            "change_type",
            name="uq_svo_unique_object_per_version",
        ),
    )
    op.create_index(
        "ix_svo_segment_version",
        "segment_version_objects",
        ["segment_id", "version"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_segment_version_objects_object_type",
        "segment_version_objects",
        ["object_type"],
        unique=False,
    )
    op.create_index(
        "ix_segment_version_objects_object_id",
        "segment_version_objects",
        ["object_id"],
        unique=False,
    )
    op.create_index(
        "ix_segment_version_objects_id", "segment_version_objects", ["id"], unique=False
    )
    op.create_index(
        "ix_segment_version_objects_change_type",
        "segment_version_objects",
        ["change_type"],
        unique=False,
    )
