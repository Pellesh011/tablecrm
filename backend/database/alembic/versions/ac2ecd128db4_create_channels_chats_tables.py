...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("AVITO", "WHATSAPP", "TELEGRAM", name="channeltype"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "CLOSED", "ARCHIVED", name="chatstatus"),
        ...
        sa.ForeignKeyConstraint(
            ["assigned_operator_id"], ["relation_tg_cashboxes.id"], ondelete="SET NULL"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "sender_type",
            sa.Enum("CLIENT", "OPERATOR", name="messagesendertype"),
            nullable=False,
        ),
        sa.Column(
            "message_type",
        ...
        sa.Column(
            "status",
            sa.Enum("SENT", "DELIVERED", "READ", "FAILED", name="messagestatus"),
            server_default="SENT",
            nullable=False,
        ),
        sa.Column(
