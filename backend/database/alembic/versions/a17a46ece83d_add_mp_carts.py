...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_marketplace_contragent_cart_id"),
        "marketplace_contragent_cart",
        ["id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["cart_id"],
            ["marketplace_contragent_cart.id"],
        ),
        sa.ForeignKeyConstraint(
            ["nomenclature_id"],
            ["nomenclature.id"],
    ...
    op.create_index(
        op.f("ix_marketplace_cart_goods_id"),
        "marketplace_cart_goods",
        ["id"],
        unique=False,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_marketplace_cart_goods_id"), table_name="marketplace_cart_goods"
    )
    op.drop_table("marketplace_cart_goods")
    op.drop_index(
        op.f("ix_marketplace_contragent_cart_id"),
        table_name="marketplace_contragent_cart",
    )
