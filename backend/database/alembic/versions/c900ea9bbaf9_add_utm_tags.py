...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_docs_sales_delivery_info_id"),
        "docs_sales_delivery_info",
        ["id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_docs_sales_utm_tags_id"), "docs_sales_utm_tags", ["id"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_docs_sales_delivery_info_id"), table_name="docs_sales_delivery_info"
    )
