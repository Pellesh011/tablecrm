...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_segment_versions_id"), "segment_versions", ["id"], unique=False
    )
    op.create_table(
        ...
        sa.Column(
            "object_type",
            sa.Enum("docs_sales", "contragents", name="segment_object_type"),
            nullable=False,
        ),
        sa.Column(
            "change_type",
            sa.Enum("added", "removed", "existing", name="segment_change_type"),
            nullable=False,
        ),
        sa.ForeignKeyConstraint(
            ["segment_id"],
    ...
    op.create_index(
        op.f("ix_segment_version_objects_change_type"),
        "segment_version_objects",
        ["change_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_segment_version_objects_id"),
        "segment_version_objects",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_segment_version_objects_object_id"),
        "segment_version_objects",
        ["object_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_segment_version_objects_object_type"),
        "segment_version_objects",
        ["object_type"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_segments_cashbox_id"), "segments", ["cashbox_id"], unique=False
    )
    op.create_index(
        op.f("ix_segments_current_version"),
        "segments",
        ["current_version"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "segments",
        sa.Column("selection_field", sa.VARCHAR(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "segments",
        sa.Column(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["contragent_id"],
            ["contragents.id"],
            name="client_segments_contragent_id_fkey",
        ),
        sa.ForeignKeyConstraint(
            ["segment_id"], ["segments.id"], name="client_segments_segment_id_fkey"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            postgresql.ENUM("added", "deleted", name="segmentstatushistory"),
            autoincrement=False,
            nullable=False,
        ),
        sa.ForeignKeyConstraint(
            ["contragent_id"],
            ["contragents.id"],
            name="client_segment_history_contragent_id_fkey",
        ),
        sa.ForeignKeyConstraint(
            ["segment_id"],
            ["segments.id"],
            name="client_segment_history_segment_id_fkey",
        ),
        sa.PrimaryKeyConstraint("id", name="client_segment_history_pkey"),
    )
    op.create_index(
        "ix_client_segment_history_id", "client_segment_history", ["id"], unique=False
    )
    ...
    op.drop_index(
        op.f("ix_segment_version_objects_object_type"),
        table_name="segment_version_objects",
    )
    op.drop_index(
        op.f("ix_segment_version_objects_object_id"),
        table_name="segment_version_objects",
    ...
    op.drop_index(
        op.f("ix_segment_version_objects_id"), table_name="segment_version_objects"
    )
    op.drop_index(
        op.f("ix_segment_version_objects_change_type"),
        table_name="segment_version_objects",
