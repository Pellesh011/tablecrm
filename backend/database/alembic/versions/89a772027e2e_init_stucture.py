...
def upgrade() -> None:
    ...
    if "amo_install_groups" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_amo_install_groups_id"), "amo_install_groups", ["id"], unique=False
        )
    if "amo_settings_load_types" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_amo_settings_load_types_id"),
            "amo_settings_load_types",
            ["id"],
            unique=False,
        )
    if "custom_fields" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_custom_fields_id"), "custom_fields", ["id"], unique=False
        )
    if "docs_sales_settings" not in existing_tables:
        op.create_table(
            ...
            sa.Column(
                ...
                sa.Enum(
                    "minutes", "hours", "days", "weeks", "months", name="repeatability"
                ),
                nullable=False,
            ),
        ...
        op.create_index(
            op.f("ix_docs_sales_settings_id"),
            "docs_sales_settings",
            ["id"],
            unique=False,
        )
    if "entity_or_function" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_entity_or_function_id"), "entity_or_function", ["id"], unique=False
        )
    ...
    if "integrations_type" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_integrations_type_id"), "integrations_type", ["id"], unique=False
        )
    ...
    if "tg_accounts" not in existing_tables:
        ...
        op.create_table(
            ...
            sa.Column(
                "is_blocked", sa.Boolean(), server_default="false", nullable=True
            ),
    ...
    if "type_template" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_type_template_id"), "type_template", ["id"], unique=False
        )
    ...
    if "amo_contacts" not in existing_tables:
        ...
        op.create_table(
            ...
            sa.ForeignKeyConstraint(
                ...
                ["amo_install_groups.id"],
            ),
            sa.PrimaryKeyConstraint("id"),
        )
        op.create_index(
            op.f("ix_amo_contacts_amo_install_group_id"),
            "amo_contacts",
            ["amo_install_group_id"],
            unique=False,
        )
        op.create_index(
            op.f("ix_amo_contacts_ext_id"), "amo_contacts", ["ext_id"], unique=False
        )
        op.create_index(
            op.f("ix_amo_contacts_id"), "amo_contacts", ["id"], unique=False
        )
    if "amo_lead_pipelines" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_amo_lead_pipelines_id"), "amo_lead_pipelines", ["id"], unique=False
        )
    if "amo_settings" not in existing_tables:
        ...
        op.create_table(
            ...
            sa.ForeignKeyConstraint(
                ["load_type_id"],
                ["amo_settings_load_types.id"],
            ),
            sa.PrimaryKeyConstraint("id"),
        )
        op.create_index(
            op.f("ix_amo_settings_id"), "amo_settings", ["id"], unique=False
        )
    ...
    if "custom_fields_values" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_custom_fields_values_id"),
            "custom_fields_values",
            ["id"],
            unique=False,
        )
    if "amo_contacts_double" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_amo_contacts_double_id"),
            "amo_contacts_double",
            ["id"],
            unique=False,
        )
    if "amo_custom_fields_comparison" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_amo_custom_fields_comparison_id"),
            "amo_custom_fields_comparison",
            ["id"],
            unique=False,
        )
    if "amo_install" not in existing_tables:
        ...
        op.create_table(
            ...
            sa.Column(
                "is_refresh", sa.Boolean(), server_default="false", nullable=True
            ),
    ...
    if "amo_install_table_cashboxes" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_amo_install_table_cashboxes_id"),
            "amo_install_table_cashboxes",
            ["id"],
            unique=False,
        )
    if "amo_integrations" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_amo_integrations_id"), "amo_integrations", ["id"], unique=False
        )
    if "amo_lead_statuses" not in existing_tables:
        ...
        op.create_table(
            ...
            sa.ForeignKeyConstraint(
                ["pipeline_id"],
                ["amo_lead_pipelines.id"],
            ),
            sa.PrimaryKeyConstraint("id"),
        )
        op.create_index(
            op.f("ix_amo_lead_statuses_id"), "amo_lead_statuses", ["id"], unique=False
        )
    ...
    if "contragents" not in existing_tables:
        ...
        op.create_table(
            ...
            sa.Column(
                "contragent_type",
                sa.Enum("Supplier", "Buyer", name="contragent_types"),
                nullable=True,
            ),
    ...
    if "doc_template" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_doc_template_id"), "doc_template", ["id"], unique=False
        )
    if "entity_to_entity" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_entity_to_entity_id"), "entity_to_entity", ["id"], unique=False
        )
    ...
    if "pay_transactions" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_pay_transactions_id"), "pay_transactions", ["id"], unique=False
        )
    ...
    if "relation_tg_cashboxes" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_relation_tg_cashboxes_id"),
            "relation_tg_cashboxes",
            ["id"],
            unique=False,
        )
    if "status_entity_function" not in existing_tables:
        ...
        op.create_table(
            ...
            sa.ForeignKeyConstraint(
                ["entity_or_function"],
                ["entity_or_function.name"],
                onupdate="CASCADE",
                ondelete="CASCADE",
            ),
            sa.PrimaryKeyConstraint("id"),
            sa.UniqueConstraint(
                "entity_or_function", "cashbox", name="function_cashbox_unique"
            ),
        )
        op.create_index(
            op.f("ix_status_entity_function_id"),
            "status_entity_function",
            ["id"],
            unique=False,
        )
    if "tag_template" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_tag_template_id"), "tag_template", ["id"], unique=False
        )
    if "amo_events_type" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_amo_events_type_id"), "amo_events_type", ["id"], unique=False
        )
    if "amo_leads" not in existing_tables:
        ...
        op.create_table(
            ...
            sa.ForeignKeyConstraint(
                ["status_id"],
                ["amo_lead_statuses.id"],
            ),
            sa.PrimaryKeyConstraint("id"),
        )
        op.create_index(
            op.f("ix_amo_leads_amo_id"), "amo_leads", ["amo_id"], unique=False
        )
        op.create_index(
            op.f("ix_amo_leads_amo_install_group_id"),
            "amo_leads",
            ["amo_install_group_id"],
            unique=False,
        )
    ...
    if "amo_table_contacts" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_amo_table_contacts_id"), "amo_table_contacts", ["id"], unique=False
        )
    ...
    if "doc_generated" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_doc_generated_id"), "doc_generated", ["id"], unique=False
        )
    ...
    if "manufacturers" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_manufacturers_id"), "manufacturers", ["id"], unique=False
        )
    ...
    if "pay_accounts_balances" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_pay_accounts_balances_id"),
            "pay_accounts_balances",
            ["id"],
            unique=False,
        )
    ...
    if "distribution_docs" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_distribution_docs_id"), "distribution_docs", ["id"], unique=False
        )
    if "fifo_settings" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_fifo_settings_id"), "fifo_settings", ["id"], unique=False
        )
    if "gross_profit_docs" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_gross_profit_docs_id"), "gross_profit_docs", ["id"], unique=False
        )
    if "integrations_to_cashbox" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_integrations_to_cashbox_id"),
            "integrations_to_cashbox",
            ["id"],
            unique=False,
        )
    if "loyality_cards" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_loyality_cards_id"), "loyality_cards", ["id"], unique=False
        )
        op.create_index(
            op.f("ix_loyality_cards_lifetime"),
            "loyality_cards",
            ["lifetime"],
            unique=False,
        )
    if "loyality_settings" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_loyality_settings_id"), "loyality_settings", ["id"], unique=False
        )
    if "nomenclature" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_nomenclature_id"), "nomenclature", ["id"], unique=False
        )
    ...
    if "docs_reconciliation" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_docs_reconciliation_id"),
            "docs_reconciliation",
            ["id"],
            unique=False,
        )
    if "docs_sales" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_docs_sales_cashbox"), "docs_sales", ["cashbox"], unique=False
        )
        op.create_index(op.f("ix_docs_sales_id"), "docs_sales", ["id"], unique=False)
        op.create_index(
            op.f("ix_docs_sales_is_deleted"), "docs_sales", ["is_deleted"], unique=False
        )
    if "evotor_credentials" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_evotor_credentials_id"), "evotor_credentials", ["id"], unique=False
        )
    if "module_bank_credentials" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_module_bank_credentials_id"),
            "module_bank_credentials",
            ["id"],
            unique=False,
        )
    if "nomenclature_barcodes" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_nomenclature_barcodes_id"),
            "nomenclature_barcodes",
            ["id"],
            unique=False,
        )
    ...
    if "tochka_bank_credentials" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_tochka_bank_credentials_id"),
            "tochka_bank_credentials",
            ["id"],
            unique=False,
        )
    if "amo_leads_docs_sales_mapping" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_amo_leads_docs_sales_mapping_id"),
            "amo_leads_docs_sales_mapping",
            ["id"],
            unique=False,
        )
        op.create_index(
            op.f("ix_amo_leads_docs_sales_mapping_lead_id"),
            "amo_leads_docs_sales_mapping",
            ["lead_id"],
            unique=False,
        )
    if "bookikng" not in existing_tables:
        ...
        op.create_table(
            ...
            sa.Column(
                "status_doc_sales",
                sa.Enum("partially_paid", "not_paid", "paid", name="docsalesstatus"),
                nullable=False,
            ),
            sa.Column(
                "status_booking",
        ...
        op.create_index(
            op.f("ix_bookikng_date_booking"), "bookikng", ["date_booking"], unique=False
        )
        op.create_index(
            op.f("ix_bookikng_end_booking"), "bookikng", ["end_booking"], unique=False
        )
        op.create_index(op.f("ix_bookikng_id"), "bookikng", ["id"], unique=False)
        op.create_index(
            op.f("ix_bookikng_start_booking"),
            "bookikng",
            ["start_booking"],
            unique=False,
        )
    if "docs_purchases" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_docs_purchases_id"), "docs_purchases", ["id"], unique=False
        )
    if "docs_sales_goods" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_docs_sales_goods_id"), "docs_sales_goods", ["id"], unique=False
        )
    if "docs_sales_tags" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_docs_sales_tags_id"), "docs_sales_tags", ["id"], unique=False
        )
        op.create_index(
            op.f("ix_docs_sales_tags_name"), "docs_sales_tags", ["name"], unique=False
        )
    if "gross_profit_docs_operations" not in existing_tables:
        ...
        op.create_table(
            ...
            sa.ForeignKeyConstraint(
                ["gross_profit_doc_id"], ["gross_profit_docs.id"], ondelete="CASCADE"
            ),
            sa.ForeignKeyConstraint(
                ["sales_manager"],
                ["relation_tg_cashboxes.id"],
        ...
        op.create_index(
            op.f("ix_gross_profit_docs_operations_id"),
            "gross_profit_docs_operations",
            ["id"],
            unique=False,
        )
    if "loyality_transactions" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_loyality_transactions_autoburned"),
            "loyality_transactions",
            ["autoburned"],
            unique=False,
        )
        op.create_index(
            op.f("ix_loyality_transactions_id"),
            "loyality_transactions",
            ["id"],
            unique=False,
        )
        op.create_index(
            op.f("ix_loyality_transactions_loyality_card_id"),
            "loyality_transactions",
            ["loyality_card_id"],
            unique=False,
        )
    if "module_bank_accounts" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_module_bank_accounts_id"),
            "module_bank_accounts",
            ["id"],
            unique=False,
        )
        op.create_index(
            op.f("ix_module_bank_accounts_module_bank_credential_id"),
            "module_bank_accounts",
            ["module_bank_credential_id"],
            unique=False,
        )
        op.create_index(
            op.f("ix_module_bank_accounts_payboxes_id"),
            "module_bank_accounts",
            ["payboxes_id"],
            unique=False,
        )
    if "payments" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_payments_cashbox"), "payments", ["cashbox"], unique=False
        )
        op.create_index(op.f("ix_payments_id"), "payments", ["id"], unique=False)
        op.create_index(
            op.f("ix_payments_paybox"), "payments", ["paybox"], unique=False
        )
    if "tochka_bank_accounts" not in existing_tables:
        ...
        op.create_table(
            ...
            sa.ForeignKeyConstraint(
                ...
                ["tochka_bank_credentials.id"],
            ),
            sa.PrimaryKeyConstraint("id"),
            sa.UniqueConstraint("accountId"),
        )
        op.create_index(
            op.f("ix_tochka_bank_accounts_id"),
            "tochka_bank_accounts",
            ["id"],
            unique=False,
        )
        op.create_index(
            op.f("ix_tochka_bank_accounts_payboxes_id"),
            "tochka_bank_accounts",
            ["payboxes_id"],
            unique=False,
        )
        op.create_index(
            op.f("ix_tochka_bank_accounts_tochka_bank_credential_id"),
            "tochka_bank_accounts",
            ["tochka_bank_credential_id"],
            unique=False,
        )
    if "booking_nomenclature" not in existing_tables:
        ...
        op.create_table(
            ...
            sa.Column("nomenclature_id", sa.Integer(), nullable=True),
            sa.Column(
                "tariff", sa.Enum("month", "day", "week", name="tariff"), nullable=False
            ),
            sa.Column(
                "created_at",
                sa.DateTime(timezone=True),
        ...
        op.create_index(
            op.f("ix_booking_nomenclature_id"),
            "booking_nomenclature",
            ["id"],
            unique=False,
        )
    if "docs_purchases_goods" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_docs_purchases_goods_id"),
            "docs_purchases_goods",
            ["id"],
            unique=False,
        )
    if "docs_warehouse" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_docs_warehouse_id"), "docs_warehouse", ["id"], unique=False
        )
    if "module_bank_operations" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_module_bank_operations_id"),
            "module_bank_operations",
            ["id"],
            unique=False,
        )
        op.create_index(
            op.f("ix_module_bank_operations_payment_crm_id"),
            "module_bank_operations",
            ["payment_crm_id"],
            unique=False,
        )
    if "tochka_bank_payments" not in existing_tables:
        ...
        op.create_table(
            ...
            sa.Column(
                "creditor_agent_accountIdentification", sa.String(), nullable=True
            ),
            ...
            sa.Column(
                "debitor_agent_accountIdentification", sa.String(), nullable=True
            ),
            sa.Column(
                "created_at",
                sa.DateTime(timezone=True),
        ...
        op.create_index(
            op.f("ix_tochka_bank_payments_id"),
            "tochka_bank_payments",
            ["id"],
            unique=False,
        )
        op.create_index(
            op.f("ix_tochka_bank_payments_payment_crm_id"),
            "tochka_bank_payments",
            ["payment_crm_id"],
            unique=False,
        )
        op.create_index(
            op.f("ix_tochka_bank_payments_payment_id"),
            "tochka_bank_payments",
            ["payment_id"],
            unique=False,
        )
    if "booking_events" not in existing_tables:
        ...
        op.create_table(
            ...
            sa.Column(
                "type",
                sa.Enum("give", "take", name="bookingeventstatus"),
                nullable=False,
            ),
            sa.Column("value", sa.String(), nullable=True),
            ...
            sa.Column("is_deleted", sa.Boolean(), nullable=True),
            sa.ForeignKeyConstraint(
                ["booking_nomenclature_id"],
                ["booking_nomenclature.id"],
            ),
            sa.PrimaryKeyConstraint("id"),
        )
        op.create_index(
            op.f("ix_booking_events_id"), "booking_events", ["id"], unique=False
        )
        op.create_index(
            op.f("ix_booking_events_type"), "booking_events", ["type"], unique=False
        )
    if "distribution_fifo_operations" not in existing_tables:
        ...
        op.create_table(
            ...
            sa.ForeignKeyConstraint(
                ["distribution_fifo"], ["distribution_docs.id"], ondelete="CASCADE"
            ),
            sa.ForeignKeyConstraint(
                ["document_purchase"],
                ["docs_purchases.id"],
        ...
        op.create_index(
            op.f("ix_distribution_fifo_operations_id"),
            "distribution_fifo_operations",
            ["id"],
            unique=False,
        )
    if "docs_warehouse_goods" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_docs_warehouse_goods_id"),
            "docs_warehouse_goods",
            ["id"],
            unique=False,
        )
    if "warehouse_balances" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_warehouse_balances_id"), "warehouse_balances", ["id"], unique=False
        )
    if "warehouse_register_movement" not in existing_tables:
        ...
        op.create_table(
            ...
            sa.Column(
                "type_amount",
                sa.Enum("plus", "minus", name="operationtype"),
                nullable=True,
            ),
            sa.Column("organization_id", sa.Integer(), nullable=True),
            sa.Column("warehouse_id", sa.Integer(), nullable=True),
        ...
        op.create_index(
            op.f("ix_warehouse_register_movement_id"),
            "warehouse_register_movement",
            ["id"],
            unique=False,
        )
    if "booking_events_photo" not in existing_tables:
        ...
        op.create_index(
            op.f("ix_booking_events_photo_id"),
            "booking_events_photo",
            ["id"],
            unique=False,
        )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_warehouse_register_movement_id"),
        table_name="warehouse_register_movement",
    )
    ...
    op.drop_index(
        op.f("ix_distribution_fifo_operations_id"),
        table_name="distribution_fifo_operations",
    )
    ...
    op.drop_index(
        op.f("ix_tochka_bank_payments_payment_id"), table_name="tochka_bank_payments"
    )
    op.drop_index(
        op.f("ix_tochka_bank_payments_payment_crm_id"),
        table_name="tochka_bank_payments",
    )
    op.drop_index(op.f("ix_tochka_bank_payments_id"), table_name="tochka_bank_payments")
    op.drop_table("tochka_bank_payments")
    op.drop_index(
        op.f("ix_module_bank_operations_payment_crm_id"),
        table_name="module_bank_operations",
    )
    op.drop_index(
        op.f("ix_module_bank_operations_id"), table_name="module_bank_operations"
    )
    ...
    op.drop_index(
        op.f("ix_tochka_bank_accounts_tochka_bank_credential_id"),
        table_name="tochka_bank_accounts",
    )
    op.drop_index(
        op.f("ix_tochka_bank_accounts_payboxes_id"), table_name="tochka_bank_accounts"
    )
    ...
    op.drop_index(
        op.f("ix_module_bank_accounts_payboxes_id"), table_name="module_bank_accounts"
    )
    op.drop_index(
        op.f("ix_module_bank_accounts_module_bank_credential_id"),
        table_name="module_bank_accounts",
    )
    op.drop_index(op.f("ix_module_bank_accounts_id"), table_name="module_bank_accounts")
    op.drop_table("module_bank_accounts")
    op.drop_index(
        op.f("ix_loyality_transactions_loyality_card_id"),
        table_name="loyality_transactions",
    )
    op.drop_index(
        op.f("ix_loyality_transactions_id"), table_name="loyality_transactions"
    )
    op.drop_index(
        op.f("ix_loyality_transactions_autoburned"), table_name="loyality_transactions"
    )
    op.drop_table("loyality_transactions")
    op.drop_index(
        op.f("ix_gross_profit_docs_operations_id"),
        table_name="gross_profit_docs_operations",
    )
    ...
    op.drop_index(
        op.f("ix_amo_leads_docs_sales_mapping_lead_id"),
        table_name="amo_leads_docs_sales_mapping",
    )
    op.drop_index(
        op.f("ix_amo_leads_docs_sales_mapping_id"),
        table_name="amo_leads_docs_sales_mapping",
    ...
    op.drop_index(
        op.f("ix_tochka_bank_credentials_id"), table_name="tochka_bank_credentials"
    )
    op.drop_table("tochka_bank_credentials")
    op.drop_index(op.f("ix_prices_id"), table_name="prices")
    op.drop_table("prices")
    op.drop_index(
        op.f("ix_nomenclature_barcodes_id"), table_name="nomenclature_barcodes"
    )
    op.drop_table("nomenclature_barcodes")
    op.drop_index(
        op.f("ix_module_bank_credentials_id"), table_name="module_bank_credentials"
    )
    ...
    op.drop_index(
        op.f("ix_integrations_to_cashbox_id"), table_name="integrations_to_cashbox"
    )
    ...
    op.drop_index(
        op.f("ix_pay_accounts_balances_id"), table_name="pay_accounts_balances"
    )
    ...
    op.drop_index(
        op.f("ix_status_entity_function_id"), table_name="status_entity_function"
    )
    op.drop_table("status_entity_function")
    op.drop_index(
        op.f("ix_relation_tg_cashboxes_id"), table_name="relation_tg_cashboxes"
    )
    ...
    op.drop_index(
        op.f("ix_amo_install_table_cashboxes_id"),
        table_name="amo_install_table_cashboxes",
    )
    ...
    op.drop_index(
        op.f("ix_amo_custom_fields_comparison_id"),
        table_name="amo_custom_fields_comparison",
    )
    ...
    op.drop_index(
        op.f("ix_amo_contacts_amo_install_group_id"), table_name="amo_contacts"
    )
    ...
    op.drop_index(
        op.f("ix_amo_settings_load_types_id"), table_name="amo_settings_load_types"
    )
